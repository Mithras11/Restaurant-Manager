namespace CollectionsLinq
{
    ...
    public class DataProcessor
    {
        ...
        {
            var product = this._foodProducts.FirstOrDefault(p => p.Name == name);
            if (product != null)
            {
                product.Price++;
            }
        ...
        public double SearchAverageOrdersForLastMonth(DateOnly startDate, DateOnly endDate)
        {
            ...
            return ordersTotalCount * 1.0 / totalDays.Days;
        }
